...
export const WheelFortune = () => {
    ...
    <>
        <div
            className='vw-100 vh-100 border-1 d-flex justify-content-center align-items-center'
            style={{
                background: '#FFFFFF',
    ...
    <>
        ...
        >
            <div className='d-flex flex-column justify-content-center bg-white brdr-6 px-3 pt-2' style={{ color: 'black', borderRadius: '6px' }}>
                <Demo />
                <div
                    style={{
                        fontFamily: 'Roboto',
